...
function fallbackEnemy(e){if(!e)return oldEnemy(e);ctx.save();try{ctx.globalAlpha=1;ctx.globalCompositeOperation='source-over';return oldEnemy(e)}finally{ctx.restore()}}
